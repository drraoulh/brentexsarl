      ...
      <div className="min-h-screen flex items-center justify-center bg-cream px-4">
        <form onSubmit={login} className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h1 className="font-display text-2xl font-bold text-primary">Administration BRENTEX</h1>
          </div>
    ...
    <div className="min-h-screen bg-cream py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-8 text-sm text-slate text-center">
          Pour modifier les activités, la galerie ou les réalisations, éditez les fichiers JSON dans <code>src/data/</code>.
