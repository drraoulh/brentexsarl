  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.72) 50%, rgba(26,26,26,0.85) 100%), url('https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=1920&q=80')",
        }}
        aria-hidden="true"
      />
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 w-full">
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Button href="/activites" variant="outline-light" size="lg">
